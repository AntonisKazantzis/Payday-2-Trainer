toggleShootWhileInteracting = not toggleShootWhileInteracting
...
if toggleShootWhileInteracting then
    ...
    function PlayerStandard:_play_unequip_animation(...) 
        old_play_unequip_animation(self, ...)
    end

    function PlayerStandard:_check_action_primary_attack(...) 
        old_check_action_primary_attack(self, ...)
    end
