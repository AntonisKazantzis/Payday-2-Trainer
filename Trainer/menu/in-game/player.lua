...
replenish = replenish or function(info)
    p2t_require("Trainer/addons/player/replenish")

    managers.mission._fading_debug_output:script().log("Replenish Player's State, Health And Ammo  - Activated", Color.green)
end
